 ...
 * Telemetry Service
 *
 * Sends anonymous usage data to helios.obilabs.dev for usage-driven development.
...
class TelemetryService {
  ...
  // Helios web endpoint
  private readonly TELEMETRY_ENDPOINT = process.env.HELIOS_TELEMETRY_URL || 'https://helios.obilabs.dev/api/instances/heartbeat';
