...
echo "------------------------------------------------------------"
curl -s "$HELIOS_API/api/google/admin/directory/v1/users?maxResults=2&domain=obilabs.dev" \
...
echo "------------------------------------------------------------"
curl -s "$HELIOS_API/api/google/admin/directory/v1/users/anthony@obilabs.dev" \
...
echo "------------------------------------------------------------"
curl -s "$HELIOS_API/api/google/admin/directory/v1/groups?domain=obilabs.dev&maxResults=3" \
  -H "Authorization: Bearer $TOKEN" | head -30
echo ""
echo ""
...
echo "Test 5: List Group Members (all-staff@obilabs.dev)"
echo "------------------------------------------------------------"
curl -s "$HELIOS_API/api/google/admin/directory/v1/groups/all-staff@obilabs.dev/members" \
  -H "Authorization: Bearer $TOKEN" | head -30
echo ""
echo ""
...
echo "------------------------------------------------------------"
curl -s "$HELIOS_API/api/google/admin/directory/v1/users/anthony@obilabs.dev/aliases" \
...
echo "------------------------------------------------------------"
curl -s "$HELIOS_API/api/google/gmail/v1/users/anthony@obilabs.dev/settings/delegates" \
  -H "Authorization: Bearer $TOKEN"
echo ""
echo ""
