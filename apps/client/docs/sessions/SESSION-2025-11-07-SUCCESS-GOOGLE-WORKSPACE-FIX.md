...
helios gw users delete testuser@obilabs.dev
helios gw groups delete testgroup@obilabs.dev
```
...
```
GET https://admin.googleapis.com/admin/directory/v1/users/mike@obilabs.dev
