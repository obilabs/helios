...
- **Test User**: jack@obilabs.dev (Admin role)
...
2. **helios gw users list** - Lists Google Workspace users
   ...
   - Successfully retrieves 4 users from Google Workspace:
     - anthony@obilabs.dev (Sales)
     - coriander@obilabs.dev (Sales)
     - mike@obilabs.dev (Admins)
     - pewter@obilabs.dev (HR, suspended)
   - **Status**: ✅ PASSING
...
- Backend logs show correct URL construction: `https://admin.googleapis.com/admin/directory/v1/users/mike@obilabs.dev`
...
- It includes the email in the URL path: `/admin/directory/v1/users/mike@obilabs.dev`
...
2025-11-07T09:33:35.180Z [info]: Proxying to Google {
  "method": "GET",
  "url": "https://admin.googleapis.com/admin/directory/v1/users/mike@obilabs.dev",
  "hasBody": true,
  "query": {}
}
