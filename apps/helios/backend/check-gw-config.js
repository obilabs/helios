...
async function testGoogleWorkspace() {
  try {
    ...
    const jwtClient = new google.auth.JWT({
      ...
      subject: 'mike@obilabs.dev' // Admin email to impersonate
    });
    ...
    console.log('\n📋 Attempting to list users from obilabs.dev...');
    ...
    if (error.message.includes('unauthorized_client')) {
      ...
      console.log('\n⚠️ The admin email "mike@obilabs.dev" might not be a super admin.');
