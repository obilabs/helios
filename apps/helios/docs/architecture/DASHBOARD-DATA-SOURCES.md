...
# Database
psql -d helios -c "SELECT COUNT(*) FROM organization_users WHERE deleted_at IS NULL;"
```
...
# Database
psql -d helios -c "SELECT COUNT(*) FROM organization_users WHERE user_status = 'suspended';"
```
...
# Database
psql -d helios -c "SELECT COUNT(*) FROM organization_users WHERE role = 'admin';"
```
