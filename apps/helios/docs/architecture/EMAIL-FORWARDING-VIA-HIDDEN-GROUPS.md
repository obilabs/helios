...
```
1. User deleted: anthony@obilabs.dev
2. Create hidden group: anthony@obilabs.dev
3. Add member: mike@obilabs.dev
...
**Result:**
- Emails to anthony@obilabs.dev → Delivered to group
- Group delivers to mike@obilabs.dev
