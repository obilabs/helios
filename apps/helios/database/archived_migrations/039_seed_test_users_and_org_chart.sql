...
BEGIN
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'jack.chen@obilabs.dev', v_password_hash, 'Jack', 'Chen',
    ...
    IF v_ceo_id IS NULL THEN
        SELECT id INTO v_ceo_id FROM organization_users WHERE email = 'jack.chen@obilabs.dev';
    END IF;
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'sarah.chen@obilabs.dev', v_password_hash, 'Sarah', 'Chen',
    ...
    IF v_cto_id IS NULL THEN
        SELECT id INTO v_cto_id FROM organization_users WHERE email = 'sarah.chen@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'robert.taylor@obilabs.dev', v_password_hash, 'Robert', 'Taylor',
    ...
    IF v_cfo_id IS NULL THEN
        SELECT id INTO v_cfo_id FROM organization_users WHERE email = 'robert.taylor@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'amanda.white@obilabs.dev', v_password_hash, 'Amanda', 'White',
    ...
    IF v_cmo_id IS NULL THEN
        SELECT id INTO v_cmo_id FROM organization_users WHERE email = 'amanda.white@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'thomas.anderson@obilabs.dev', v_password_hash, 'Thomas', 'Anderson',
    ...
    IF v_coo_id IS NULL THEN
        SELECT id INTO v_coo_id FROM organization_users WHERE email = 'thomas.anderson@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'michael.rodriguez@obilabs.dev', v_password_hash, 'Michael', 'Rodriguez',
    ...
    IF v_vp_eng_id IS NULL THEN
        SELECT id INTO v_vp_eng_id FROM organization_users WHERE email = 'michael.rodriguez@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'jennifer.lee@obilabs.dev', v_password_hash, 'Jennifer', 'Lee',
    ...
    IF v_vp_product_id IS NULL THEN
        SELECT id INTO v_vp_product_id FROM organization_users WHERE email = 'jennifer.lee@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'david.kim@obilabs.dev', v_password_hash, 'David', 'Kim',
    ...
    IF v_eng_mgr_1_id IS NULL THEN
        SELECT id INTO v_eng_mgr_1_id FROM organization_users WHERE email = 'david.kim@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'rachel.green@obilabs.dev', v_password_hash, 'Rachel', 'Green',
        'Engineering Manager', 'Engineering', v_dept_eng_id,
        'manager', 'active', true, 'Full Time', v_vp_eng_id
    ) ON CONFLICT (email) DO UPDATE SET
        job_title = EXCLUDED.job_title, reporting_manager_id = v_vp_eng_id
    ...
    IF v_eng_mgr_2_id IS NULL THEN
        SELECT id INTO v_eng_mgr_2_id FROM organization_users WHERE email = 'rachel.green@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'nathan.brown@obilabs.dev', v_password_hash, 'Nathan', 'Brown',
    ...
    IF v_product_mgr_id IS NULL THEN
        SELECT id INTO v_product_mgr_id FROM organization_users WHERE email = 'nathan.brown@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'michelle.wang@obilabs.dev', v_password_hash, 'Michelle', 'Wang',
    ...
    IF v_finance_mgr_id IS NULL THEN
        SELECT id INTO v_finance_mgr_id FROM organization_users WHERE email = 'michelle.wang@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'kevin.lee@obilabs.dev', v_password_hash, 'Kevin', 'Lee',
    ...
    IF v_marketing_mgr_id IS NULL THEN
        SELECT id INTO v_marketing_mgr_id FROM organization_users WHERE email = 'kevin.lee@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'stephanie.davis@obilabs.dev', v_password_hash, 'Stephanie', 'Davis',
    ...
    IF v_ops_mgr_id IS NULL THEN
        SELECT id INTO v_ops_mgr_id FROM organization_users WHERE email = 'stephanie.davis@obilabs.dev';
    ...
    INSERT INTO organization_users (
        ...
        gen_random_uuid(), v_org_id, 'nicole.baker@obilabs.dev', v_password_hash, 'Nicole', 'Baker',
    ...
    IF v_hr_mgr_id IS NULL THEN
        SELECT id INTO v_hr_mgr_id FROM organization_users WHERE email = 'nicole.baker@obilabs.dev';
    ...
    (v_org_id, 'emily.watson@obilabs.dev', v_password_hash, 'Emily', 'Watson', 'Senior Software Engineer', 'Engineering', v_dept_eng_id, 'user', 'active', true, 'Full Time', v_eng_mgr_1_id),
    (v_org_id, 'james.chen@obilabs.dev', v_password_hash, 'James', 'Chen', 'Software Engineer', 'Engineering', v_dept_eng_id, 'user', 'active', true, 'Full Time', v_eng_mgr_1_id),
    (v_org_id, 'lisa.park@obilabs.dev', v_password_hash, 'Lisa', 'Park', 'Software Engineer', 'Engineering', v_dept_eng_id, 'user', 'active', true, 'Full Time', v_eng_mgr_1_id)
    ON CONFLICT (email) DO UPDATE SET
    ...
    (v_org_id, 'chris.martinez@obilabs.dev', v_password_hash, 'Chris', 'Martinez', 'Software Engineer', 'Engineering', v_dept_eng_id, 'user', 'active', true, 'Full Time', v_eng_mgr_2_id),
    (v_org_id, 'amy.thompson@obilabs.dev', v_password_hash, 'Amy', 'Thompson', 'Junior Software Engineer', 'Engineering', v_dept_eng_id, 'user', 'active', true, 'Full Time', v_eng_mgr_2_id)
    ON CONFLICT (email) DO UPDATE SET
        reporting_manager_id = EXCLUDED.reporting_manager_id, job_title = EXCLUDED.job_title;
    ...
    (v_org_id, 'sophia.garcia@obilabs.dev', v_password_hash, 'Sophia', 'Garcia', 'Senior UX Designer', 'Product', v_dept_product_id, 'user', 'active', true, 'Full Time', v_product_mgr_id),
    (v_org_id, 'oliver.smith@obilabs.dev', v_password_hash, 'Oliver', 'Smith', 'UX Designer', 'Product', v_dept_product_id, 'user', 'active', true, 'Full Time', v_product_mgr_id)
    ON CONFLICT (email) DO UPDATE SET
        reporting_manager_id = EXCLUDED.reporting_manager_id, job_title = EXCLUDED.job_title;
    ...
    (v_org_id, 'daniel.johnson@obilabs.dev', v_password_hash, 'Daniel', 'Johnson', 'Senior Accountant', 'Finance', v_dept_finance_id, 'user', 'active', true, 'Full Time', v_finance_mgr_id),
    (v_org_id, 'ashley.williams@obilabs.dev', v_password_hash, 'Ashley', 'Williams', 'Accountant', 'Finance', v_dept_finance_id, 'user', 'active', true, 'Full Time', v_finance_mgr_id)
    ON CONFLICT (email) DO UPDATE SET
        reporting_manager_id = EXCLUDED.reporting_manager_id, job_title = EXCLUDED.job_title;
    ...
    (v_org_id, 'jessica.chen@obilabs.dev', v_password_hash, 'Jessica', 'Chen', 'Marketing Specialist', 'Marketing', v_dept_marketing_id, 'user', 'active', true, 'Full Time', v_marketing_mgr_id),
    (v_org_id, 'brandon.miller@obilabs.dev', v_password_hash, 'Brandon', 'Miller', 'Content Writer', 'Marketing', v_dept_marketing_id, 'user', 'active', true, 'Full Time', v_marketing_mgr_id)
    ON CONFLICT (email) DO UPDATE SET
        reporting_manager_id = EXCLUDED.reporting_manager_id, job_title = EXCLUDED.job_title;
    ...
    (v_org_id, 'ryan.cooper@obilabs.dev', v_password_hash, 'Ryan', 'Cooper', 'Operations Analyst', 'Operations', v_dept_ops_id, 'user', 'active', true, 'Full Time', v_ops_mgr_id)
    ON CONFLICT (email) DO UPDATE SET
        reporting_manager_id = EXCLUDED.reporting_manager_id, job_title = EXCLUDED.job_title;
    ...
    (v_org_id, 'eric.wilson@obilabs.dev', v_password_hash, 'Eric', 'Wilson', 'HR Specialist', 'Human Resources', v_dept_hr_id, 'user', 'active', true, 'Full Time', v_hr_mgr_id)
    ON CONFLICT (email) DO UPDATE SET
        reporting_manager_id = EXCLUDED.reporting_manager_id, job_title = EXCLUDED.job_title;
    ...
    (v_org_id, 'grace.liu@obilabs.dev', v_password_hash, 'Grace', 'Liu', 'Data Analyst', 'Operations', v_dept_ops_id, 'user', 'active', true, 'Full Time', NULL)
    ON CONFLICT (email) DO UPDATE SET
    ...
    (v_org_id, 'jake.roberts@obilabs.dev', v_password_hash, 'Jake', 'Roberts', 'Marketing Intern', 'Marketing', v_dept_marketing_id, 'user', 'active', true, 'Intern', NULL)
    ON CONFLICT (email) DO UPDATE SET
    ...
    WHERE organization_id = v_org_id
    AND email IN (
        'emily.watson@obilabs.dev',      -- Senior Engineer
        'sophia.garcia@obilabs.dev',     -- UX Designer
        'jessica.chen@obilabs.dev',      -- Marketing
        'nathan.brown@obilabs.dev'       -- Product Manager (lead)
    )
    ON CONFLICT (access_group_id, user_id) DO NOTHING;
