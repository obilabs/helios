...
try {
    ...
    if ($psOutput -match "helios_backend.*Up.*healthy") {
    ...
    if ($psOutput -match "helios_frontend.*Up.*healthy") {
    ...
    if ($psOutput -match "helios_postgres.*Up.*healthy") {
    ...
    if ($psOutput -match "helios_redis.*Up.*healthy") {
