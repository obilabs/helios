...
docker exec helios_redis redis-cli EVAL "return redis.call('del', unpack(redis.call('keys', 'bull:*')))" 0

# Clear everything (DANGEROUS)
docker exec helios_redis redis-cli FLUSHALL

# Clear specific queue
docker exec helios_redis redis-cli EVAL "return redis.call('del', unpack(redis.call('keys', 'bull:bulk-operations:*')))" 0
```
