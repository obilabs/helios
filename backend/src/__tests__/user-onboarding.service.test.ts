  ...
  describe('Onboarding Execution', () => {
    ...
    describe('addToGroups', () => {
      it('should add user to specified groups', async () => {
        ...
        mockQuery.mockResolvedValueOnce({ rows: [{ admin_email: 'admin@obilabs.dev' }] });
        ...
        // Mock group lookups
        mockQuery.mockResolvedValueOnce({
          rows: [{ email: 'group1@obilabs.dev', external_id: 'group-1-ext' }],
        });
        mockQuery.mockResolvedValueOnce({
          rows: [{ email: 'group2@obilabs.dev', external_id: 'group-2-ext' }],
        });
