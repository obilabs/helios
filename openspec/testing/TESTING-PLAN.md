...
|-------|----------|------|---------|
| manager@obilabs.dev | ***REMOVED-CREDENTIAL*** | manager | Manager role tests |
| user@obilabs.dev | ***REMOVED-CREDENTIAL*** | user | Basic user tests |
| disabled@obilabs.dev | ***REMOVED-CREDENTIAL*** | user | Disabled account tests |
